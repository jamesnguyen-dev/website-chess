  ...
  document.addEventListener("locations", function (e) {
    document.addEventListener("thisIsMe", function (t) {
      ...
      if (t.detail.type != "Pawn") {
        ...
        if (
          e.detail[1].length > 0 &&
          _this.board["x" + e.detail[1][0].x + "y" + e.detail[1][0].y].occ &&
          _this.board["x" + e.detail[1][0].x + "y" + e.detail[1][0].y].unit
            .team != t.detail.team
        ) {
          _this.targets.push(
            _this.board["x" + e.detail[1][0].x + "y" + e.detail[1][0].y]
          );
        }
        if (
          e.detail[2].length > 0 &&
          _this.board["x" + e.detail[2][0].x + "y" + e.detail[2][0].y].occ &&
          _this.board["x" + e.detail[2][0].x + "y" + e.detail[2][0].y].unit
            .team != t.detail.team
        ) {
          _this.targets.push(
            _this.board["x" + e.detail[2][0].x + "y" + e.detail[2][0].y]
          );
        }
      }
...
Play.prototype = {
  ...
  displayInfo: function (unit) {
    if (unit != undefined) {
      document.querySelector("#info > ul:first-of-type").style.visibility =
        "hidden";
      this.data.innerHTML = "";
      ...
      up.innerHTML =
        "Units Position: " + "x: " + unit.pos.x + ", y: " + unit.pos.y;
      ...
      ul.innerHTML =
        ...
        (this.validPos.length + this.targets.length);
      ...
      document.querySelector("#info > ul:first-of-type").style.visibility =
        "visible";
      document.querySelector("#info > ul:first-of-type > p").innerHTML =
        this.round + "<br>Turn";
      document.querySelector("#info > ul:first-of-type").className =
        this.round + "Turn";
  ...
  moveHere: function (e) {
    ...
    temp.split("");
    p.board["x" + temp[3] + "y" + temp[1]].obj.appendChild(
      p.selected.getDomObj()
    );
    p.board["x" + temp[3] + "y" + temp[1]].occ = true;
    p.board["x" + temp[3] + "y" + temp[1]].unit = p.selected;
    p.board[
      "x" + p.selected.pos.y + "y" + p.selected.pos.x
    ].obj.className = p.board[
      "x" + p.selected.pos.y + "y" + p.selected.pos.x
  ...
  kill: function (e) {
    ...
    p.selected.kills += 1;
    target.dead = true;
    if (e.target.className.split(" ")[0] == "whites") {
  ...
  gameOver: function (losers) {
    ...
    document
      .querySelector("#over .butt:first-of-type")
      .addEventListener("click", function () {
        _this.startNewGame();
      });
    document
      .querySelector("#over .butt:last-of-type")
      .addEventListener("click", function () {
        _this.round = null;
        document.getElementById("over").style.visibility = "hidden";
      });
  ...
  teamwhites: function () {
    ...
    temp.team = "whites";
    temp.pos = { x: 1, y: 8 };
    temp.getDomObj().className = "whites rook";
    ...
    temp.team = "whites";
    temp.pos = { x: 2, y: 8 };
    temp.getDomObj().className = "whites knight";
    this.whites.push(temp);
    ...
    temp.team = "whites";
    temp.pos = { x: 3, y: 8 };
    temp.getDomObj().className = "whites bishop";
    this.whites.push(temp);
    ...
    temp.team = "whites";
    temp.pos = { x: 4, y: 8 };
    temp.getDomObj().className = "whites queen";
    this.whites.push(temp);
    ...
    temp.team = "whites";
    temp.pos = { x: 5, y: 8 };
    temp.getDomObj().className = "whites king";
    this.whites.push(temp);
    ...
    for (var i = 1; i <= 8; i++) {
      ...
      temp.team = "whites";
      temp.pos = { x: i, y: 7 };
      temp.getDomObj().className = "whites pawn";
      this.whites.push(temp);
  ...
  nDiv.addEventListener("click", function () {
    if (p.round == _this.team && !_this.dead) {
      document.dispatchEvent(
        new CustomEvent("locations", { detail: eval(_this.movement) })
      );
